  ...
  return (
    <Container className="py-16">
      <article className="prose-deal mx-auto max-w-2xl">
        <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl">Editorial policy</h1>
        <p className="mt-4 text-lg leading-relaxed text-muted">
          A deals site is only worth reading if you can trust the numbers on it. Here is exactly
        ...
        <p>
          ...
          itself — not hidden behind a sign-up. If our summary and the vendor page disagree, the
          vendor page is right and we are wrong. Tell us and we will fix it.
        </p>
